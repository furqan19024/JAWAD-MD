...
const config = {
  SESSION_ID: process.env.SESSION_ID || "prince_md-3RFwHDpD#VehETMhFejjHS1MooT5s4OtDDcVZjWfUaYKTp7GD83g",
  ...
  ANTU_LINK: process.env.ANTI_LINK !== undefined ? process.env.ANTI_LINK === 'true' : false,
};
